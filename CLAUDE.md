...
**YOU ARE IN: `traitprint/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/traitprint/` (rig root) or other directories
...
**Your mail address:** `traitprint/polecats/chrome`
**Your rig:** traitprint
**Your Witness:** `traitprint/witness`
...
| Ask Witness for help | `gt mail send traitprint/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`traitprint/witness`) when:
...
```bash
gt mail send traitprint/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
